  ...
  return (
   <div>
    <div className='w-full lg:h-80 lg:flex h-[400px] lg:mt-2 flex flex-col-reverse lg:flex-row'>
     ...
     {user?<button className='lg:w-80 lg:h-16 w-60 rounded-sm h-11 lg:rounded-md lg:text-xl font-semibold text-[14px] bg-blue-500 lg:font-bold capitalize'>join prime annual at rs125/month</button>:<Link to={'/login'}> <button className='lg:w-80 lg:h-12 w-40 h-7 lg:rounded-md lg:text-xl font-semibold text-[8px] bg-blue-500 lg:font-bold capitalize'>sign to join prime</button></Link>}
      </div>
