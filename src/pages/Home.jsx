  ...
  return (
   <div>
    <div className='w-full lg:h-80 lg:flex h-[400px] lg:mt-2 flex flex-col-reverse lg:flex-row'>
      ...
      <h1 className='lg:text-4xl font-simbold text-xl '>Welcome to Prime Video</h1>
      <p className='lg:text-xl font-semibold text-[8px] '>join Prime to watch the latest movies, TV shows and award-winning Amazon Originals</p>
     <Link to={'/login'}> <button className='lg:w-80 lg:h-12 w-40 h-7 lg:rounded-md lg:text-xl font-semibold text-[8px] bg-blue-500 lg:font-bold capitalize'>sign to join prime</button></Link>
      </div>
    ...
    <div className='w-full h-[500px] lg:h-[400px] lg:flex lg:mt-56 mt-16 flex flex-col-reverse lg:flex-row'>
      ...
      <h1 className='lg:text-4xl font-semibold text-xl '>Movie rentals on Prime Video</h1>
      <p className='lg:text-xl font-semibold text-[8px]'>Early Access to new movies, before digital subscription</p>
